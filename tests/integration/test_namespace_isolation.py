...
async def test_module_detail_unauthorized_namespace_returns_403(client):
    """GET /api/modules/:ns/:name/:provider should return 403 for unauthorized namespace."""
...
async def test_download_unauthorized_namespace_returns_403(client):
    """GET /v1/modules/:ns/:name/:provider/:version/download should deny unauthorized access."""
...
async def test_upload_unauthorized_namespace_returns_403(client):
    """POST /v1/modules/:ns/:name/:provider/:version should deny unauthorized upload."""
...
async def test_version_list_unauthorized_namespace_returns_403(client):
    """GET /v1/modules/:ns/:name/:provider/versions should deny unauthorized access."""
